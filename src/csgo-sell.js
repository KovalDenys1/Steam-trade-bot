...
/**
 * Sell CS:GO items from inventory with dynamic pricing
 */
async function sellCsgoItems() {
  const credentials = {
  ...
  try {
    ...
    console.log('🎮 Starting CS:GO item selling with dynamic pricing\n');
